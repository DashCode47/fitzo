  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.visualHeader}>
        ...
        />
        <LinearGradient
          colors={["transparent", theme.bgDeep]}
      ...
      >
        <View style={styles.infoBox}>
          ...
          <Text style={styles.description}>
            {routine.description || "Prepárate para superar tus límites hoy."}
          </Text>
          ...
          <View style={styles.metricsRow}>
            ...
            <View style={styles.metricItem}>
              ...
              <Text style={styles.metricLabel}>
                {RoutinesAPI.translateGoal(routine.goal)}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={styles.sectionSubtitle}>
            ¡Supera tus récords en ejercicios con el tag RANKING para subir de
            rango!
          </Text>
        </View>
          ...
          <View key={item.id} style={styles.exerciseCard}>
            ...
            <View style={styles.exerciseInfo}>
              ...
              <Text style={styles.exerciseMeta}>
                ...
                {item.suggested_weight ? `· ${item.suggested_weight}` : ""}
              </Text>
              {item.notes && (
