...
function PodiumView({
  ...
  const tierInfo = (entry?: LeaderboardItem) =>
    entry
      ? RANK_TIERS.find((t) => t.name === entry.rankTier) || RANK_TIERS[0]
      : RANK_TIERS[0];
  ...
  const podiumSlot = (
    ...
    return (
      ...
      >
        ...
        {pos === 1 && (
          <Animated.View
            style={{ transform: [{ translateY: crownFloat }], marginBottom: 4 }}
          >
        ...
        >
          ...
          <Text style={{ fontSize: 9, fontWeight: "800", color: tier.color }}>
            {tier.name}
          </Text>
        </View>
    ...
    <>
      ...
      <View style={styles.posCol}>
        {isFirst ? (
          ...
          <Text style={[styles.posNum, isMe && { color: theme.accent }]}>
            {item.position}
          </Text>
        )}
      </View>
      <View
        style={[
          styles.avatarWrap,
          isFirst && [
            styles.avatarWrapFirst,
            { borderWidth: 2.5, borderColor: RANK_COLORS[0] },
          ],
      ...
      <View style={styles.nameCol}>
        ...
        <Text
          style={[
            styles.scoreText,
            isFirst && { color: "#C5A35699" },
            isMe && !isFirst && styles.scoreTextMe,
          ]}
        >
  ...
  const loadLeaderboard = async () => {
    try {
      ...
      const data = await withTimeout(
        LeaderboardAPI.getRankLeaderboard(),
        15000,
  ...
  return (
    <View style={styles.root}>
      ...
      <SafeAreaView style={{ flex: 1 }} edges={["top"]}>
        ...
        <View style={styles.segmentContainer}>
          <TouchableOpacity
            style={[
              styles.segmentBtn,
              viewMode === "tabla" && styles.segmentBtnActive,
            ]}
          ...
          >
            <Text
              style={[
                ...
                viewMode === "tabla" && styles.segmentBtnTextActive,
              ]}
            >
              Tabla
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.segmentBtn,
              viewMode === "misrangos" && styles.segmentBtnActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.segmentBtnText,
                viewMode === "misrangos" && styles.segmentBtnTextActive,
              ]}
            >
              Mis Rangos
            </Text>
                ...
                >
                  ...
                  <View style={styles.myCardInfo}>
                    ...
                    <Text style={styles.myCardPos}>
                      Posición #{myEntry.position} de {leaderboard.length}
                    </Text>
                  </View>
                  <View style={styles.myCardRight}>
                    <View
                      style={[
                        styles.myCardTier,
                        { backgroundColor: myTierInfo.color + "25" },
                      ]}
                    >
                      <Ionicons
                        name={myTierInfo.icon as any}
                        size={12}
                        color={myTierInfo.color}
                      />
                      <Text
                        style={[
                          styles.myCardTierText,
                          { color: myTierInfo.color },
                        ]}
                      >
                        {myTierInfo.name}
                    ...
                    <Text style={styles.myCardScore}>
                      Score {myEntry.rankIndex.toFixed(2)}
                    </Text>
                  </View>
                </LinearGradient>
              </View>
      ...
      <RankingInfoModal
        ...
        currentTierIndex={
          myEntry
            ? RANK_TIERS.findIndex((t) => t.name === myEntry.rankTier)
            : -1
        }
      />
    </View>
