    ...
    <section id="cta" className="relative py-24 md:py-32 section-padding overflow-hidden">
      ...
      >
        <div
          ...
          style={{ background: "radial-gradient(ellipse, #7B2FF7 0%, transparent 65%)" }}
        />
      </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-6"
          style={{ background: "rgba(123,47,247,0.12)", border: "1px solid rgba(123,47,247,0.35)" }}>
        ...
        <h2 className="text-4xl md:text-6xl font-black text-white mb-6 leading-tight">
          Tu gimnasio, listo
          <br />
          <span className="gold-text">en 24 horas</span>
        </h2>

        <p className="text-white/50 text-lg mb-12 leading-relaxed max-w-xl mx-auto">
          Sin contratos, sin tarjeta de crédito. Nosotros configuramos todo —
          tú solo dinos el nombre de tu gimnasio y en un día ya estás operando.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          ...
          >
            ...
            Quiero activar mi gimnasio
          </a>
        </div>

        <p className="text-white/25 text-sm">
          App para miembros disponible en iOS y Android · Configuración incluida
        </p>
      </div>
    </section>
  );
