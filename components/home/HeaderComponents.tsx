        ...
        <View style={styles.crowdLeft}>
          ...
          <View>
            ...
            <View style={styles.crowdStatusRow}>
              ...
              <Text style={[styles.crowdStatusText, { color: barColor }]}>
                {status}
              </Text>
        ...
        <View style={styles.crowdChips}>
          {users.map((u, i) => (
            <View key={u._id || i} style={styles.chip}>
              <View
                style={[styles.chipDot, { backgroundColor: theme.accent }]}
              />
              <Text style={styles.chipText}>
                {u.metadata?.name || u.userId || "–"}
              </Text>
            </View>
          ))}
        </View>
            ...
            <View style={styles.promoContent}>
              {item.tag && (
                <View
                  style={[
                    styles.badge,
                    { backgroundColor: BADGE_COLORS[item.tag] ?? theme.accent },
                  ]}
                >
