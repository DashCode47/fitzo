...
// ─── Shimmer bone ─────────────────────────────────────────────────────────────
function Bone({ w, h, radius = 8, style, theme }: { w: number | string; h: number; radius?: number; style?: any; theme: AppTheme }) {
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.cardBody}>
        ...
        <Bone w="65%" h={13} radius={4} style={{ marginTop: 4 }} theme={theme} />
        <Bone w="80%" h={11} radius={4} style={{ marginTop: 6 }} theme={theme} />
        <Bone w="55%" h={11} radius={4} style={{ marginTop: 3 }} theme={theme} />
